...
if (
    os.path.isfile(f"{userconfigpath}/meta_config_multipyinjector")
    and multi_injection != "on"
    and pyinjection == "off"
):
    print_status(
...
if (
    multi_injection != "on"
    and pyinjection == "off"
    and not os.path.isfile(f"{userconfigpath}/meta_config_multipyinjector")
):
